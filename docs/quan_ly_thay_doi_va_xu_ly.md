...
| Vai trò         | Trách nhiệm                           |
| --------------- | ------------------------------------- |
| Project Manager | Kiểm soát phạm vi, ngân sách, tiến độ |
| Technical Lead  | Đánh giá tác động kiến trúc           |
| Hardware Lead   | Đánh giá ảnh hưởng BOM/PCB            |
| QA Lead         | Đánh giá kiểm thử và độ ổn định       |
| Product Owner   | Đánh giá giá trị người dùng           |
...
| Cấp độ          | Loại                      | Ví dụ                 |
| --------------- | ------------------------- | --------------------- |
| Minor Change    | Không ảnh hưởng kiến trúc | Đổi tên biến, UI text |
| Major Change    | Ảnh hưởng module          | Thay DHT11 → DHT22    |
| Critical Change | Ảnh hưởng hệ thống        | Thay kiến trúc OTA    |
...
| --------------- | ------------------ |
| Change Approved | Trigger pipeline   |
| Code Merge      | Auto build         |
| Test Pass       | Auto release       |
| Deploy          | OTA staged rollout |
...
➡️ Chuyển hóa dự án từ **Project Execution** → **Project Governance System**
